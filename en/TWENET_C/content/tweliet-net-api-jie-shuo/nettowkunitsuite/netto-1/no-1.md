...
The method of reception is much the same as for simple nets, with the exception of the [`tsRxDataApp`](../../../twelite-net-api-rifurensu/netto-api/structure/tsrxdataapp-netto.md) structure.
