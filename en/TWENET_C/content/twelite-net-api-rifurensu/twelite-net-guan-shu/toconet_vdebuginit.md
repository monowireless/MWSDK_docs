...
The specified [UART](../../hw-api-rifurensu/perifuraru/uart/) output is used in common with the application's output, and debug messages are output during the application's output.

{% hint style="warning" %}
Set `TOCONET_DEBUG` to `1` in the [Makefile](../../twelite-sdkno/birudonitsuite/makefile-nitsuite.md) and run the build.
{% endhint %}
...
| Type                                                                              | Name   | Remark                                                       |
| --------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------ |
| [`tsFILE`](../../hw-api-rifurensu/perifuraru/uart/fprintf-raiburari/tsfile.md)`*` | `pSer` | Pointer to a structure defining the UART output destination. |
